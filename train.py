...
tf.flags.DEFINE_integer("rnn_size", 100, "rnn_size (default: 100)")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def dev_step(x_batch, y_batch, batch_size, writer=None):
            """
            ...
            for batch in range(batches_in_dev):
                ...
                feed_dict = {
                  cnn.input_x: x_batch[start_index:end_index],
                  cnn.input_y: y_batch[start_index:end_index],
        ...
        for batch in batches:
            ...
            if current_step % FLAGS.evaluate_every == 0:
                print("\nEvaluation:")
                dev_step(x_dev, y_dev, batch_size=FLAGS.batch_size, writer=dev_summary_writer)
                print("")
